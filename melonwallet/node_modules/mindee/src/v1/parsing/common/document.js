import { CropperExtra, FullTextOcrExtra, Extras } from "./extras/index.js";
import { Ocr } from "./ocr.js";
import { RAGExtra } from "./extras/ragExtra.js";
/**
    ...
    constructor(inferenceClass, httpResponse) {
        ...
        if (httpResponse["extras"] &&
            ...
            Object.entries(httpResponse["extras"]).forEach(([extraKey, extraValue]) => {
                switch (extraKey) {
                    case "cropper":
                        extras["cropper"] = new CropperExtra(extraValue);
                        break;
                    case "full_text_ocr":
                        extras["fullTextOcr"] = new FullTextOcrExtra(extraValue);
                        break;
                    case "rag":
                        extras["rag"] = new RAGExtra(extraValue);
                        break;
                }
            });

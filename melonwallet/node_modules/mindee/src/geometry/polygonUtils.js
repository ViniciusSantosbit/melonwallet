 ...
 */
export function isPointInPolygonY(centroid, polygon) {
 ...
 */
export function relativeY(polygon) {
    const sum = polygon
        .map((point) => point[1])
        .reduce((prev, cur) => prev + cur);
 ...
 */
export function isPointInPolygonX(centroid, polygon) {
 ...
 */
export function relativeX(polygon) {
    const sum = polygon
        .map((point) => point[0])
        .reduce((prev, cur) => prev + cur);
    return polygon.length * sum;

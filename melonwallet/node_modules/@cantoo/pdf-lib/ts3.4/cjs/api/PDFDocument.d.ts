...
import { ConvertToPDFAOptions } from './pdfa';
...
export default class PDFDocument {
     ...
     */
    static load(pdf: BinaryData, options?: LoadOptions): Promise<PDFDocument>;
    /**
     ...
     * [[getForm]], which strips XFA data when `preserveXFA` is not set.
     */
    setXFAJavaScript(fieldName: string, eventName: string, newScript: string): void;
    /**
     ...
     */
    attach(attachment: BinaryData, name: string, options?: AttachmentOptions): Promise<void>;
     ...
     */
    embedFont(font: StandardFonts | BinaryData, options?: EmbedFontOptions): Promise<PDFFont>;
    /**
     ...
     */
    embedJpg(jpg: BinaryData): Promise<PDFImage>;
    /**
     ...
     * @returns Resolves with the embedded image.
     */
    embedPng(png: BinaryData): Promise<PDFImage>;
    embedSvg(svg: string): Promise<PDFSvg>;
    /**
     ...
     */
    embedPdf(pdf: BinaryData | PDFDocument, indices?: number[]): Promise<PDFEmbeddedPage[]>;
    /**
     ...
     * @returns Resolves with the bytes of the serialized document.
     */
    saveIncremental(snapshot: DocumentSnapshot, options?: IncrementalSaveOptions): Promise<Uint8Array>;
    /**
     ...
     */
    commit(options?: IncrementalSaveOptions): Promise<Uint8Array>;
    ...
    private writeCatalogMetadataXml;
    private getInfoDict;

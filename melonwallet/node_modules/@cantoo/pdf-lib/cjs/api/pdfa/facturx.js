...
const buildFacturXDescription = (options) => `<rdf:Description rdf:about="" xmlns:fx="${exports.FACTUR_X_NAMESPACE_URI}">` +
    ...
    `<fx:ConformanceLevel>${(0, html_entities_1.encode)(options.conformanceLevel)}</fx:ConformanceLevel>` +
    '</rdf:Description>';
 ...
 */
const embedFacturX = (pdfDoc, invoiceXml, options = {}) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {

...
const PDFJavaScriptAction_1 = require("./PDFJavaScriptAction");
...
class PDFPage {
    ...
    getJavaScriptActions() {
        const aaDict = this.node.lookupMaybe(core_1.PDFName.of('AA'), core_1.PDFDict);
        if (!aaDict)
            return undefined;
        return (0, PDFJavaScriptAction_1.extractAdditionalActions)(aaDict, this.doc, 'page');
    }
    /**
    ...
    drawText(text, options = {}) {
        ...
        (0, utils_1.assertOrUndefined)(options.characterSpacing, 'options.characterSpacing', [
            'number',
        ]);
